    ...
    <>
      ...
      {enrolledCourses.length === 0 ? (
        <EmptyState
          ...
          description="Your haven't purchased any courses yet."
      ...
      <section className="mt-10">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground mb-5">Here you can see all the courses you can purchase</p>
        </div>
        ...
        {courses.filter(
          ...
          <EmptyState
            ...
            description="You have already purchased all availabel corses."
            buttonText="Browse Courses"
            href="/courses"
          />
        ) : (
