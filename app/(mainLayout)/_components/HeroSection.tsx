  ...
  return (
    <section className="relative py-18 px-4 bg-gradient-to-r">
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1522202176988-66273c2fd55f?fm=jpg&q=60&w=3000)",
      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <p className="max-w-[700px] md:text-xl text-white">
            Discover a new way to learn, connect, and grow with interactive courses, expert instructors, and a vibrant community.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-2">
            <Link
              ...
              className={buttonVariants({
                size: "lg",
                className:
                  "text-white font-bold shadow-lg transform transition hover:scale-105",
              })}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="bg-transparent border border-white/10 backdrop-blur-md hover:shadow-lg transition-shadow"
            >
              <CardHeader>
